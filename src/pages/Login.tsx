      ...
      <div style={card}>
        ...
        <form onSubmit={submit} style={{ marginTop: spacing.xl }}>
          ...
          <div style={rowBetween}>
            <span />
            <button type="button" onClick={() => alert("Contact your Fleet Manager to reset your password.")} style={linkBtn}>
              Forgot password?
            </button>
          </div>
...
const bgGlow: React.CSSProperties = {
  ...
  background: "radial-gradient(circle at center, rgba(59,130,246,0.16), rgba(59,130,246,0.04), transparent 60%)",
  filter: "blur(10px)", top: "50%", left: "50%",
...
const backBtn: React.CSSProperties = {
  ...
  fontFamily: typography.fontFamily, zIndex: 10,
};

const card: React.CSSProperties = {
  width: "min(420px, 92vw)", borderRadius: radius.lg,
  border: `1px solid ${colors.border}`, background: colors.surface,
  boxShadow: "0 24px 60px rgba(0,0,0,0.55)", padding: spacing.xl, position: "relative",
};
...
const inputStyle: React.CSSProperties = {
  ...
  color: colors.textPrimary, padding: "0 12px", fontSize: 14,
...
const linkBtn: React.CSSProperties = {
  border: "none", background: "transparent", color: "rgba(59,130,246,0.95)",
  fontSize: 13, cursor: "pointer", padding: 0, fontFamily: typography.fontFamily,
};

const errorBox: React.CSSProperties = {
  marginTop: spacing.md, padding: "10px 12px", borderRadius: 12,
  border: "1px solid rgba(255,92,115,0.32)", background: "rgba(255,92,115,0.10)",
  color: "rgba(255,255,255,0.92)", fontSize: 13,
};

const primaryBtn: React.CSSProperties = {
  width: "100%", height: 42, marginTop: spacing.md, borderRadius: 12,
  border: "1px solid rgba(59,130,246,0.40)", background: "rgba(59,130,246,0.22)",
  color: "rgba(255,255,255,0.92)", cursor: "pointer", fontSize: 14,
  fontWeight: 700, fontFamily: typography.fontFamily,
};
...
const metaChip: React.CSSProperties = {
  ...
  color: colors.textSecondary, fontSize: 12, fontFamily: typography.monoFamily,
};

const css = `
  input:focus { border-color: rgba(59,130,246,0.45) !important; box-shadow: 0 0 0 4px rgba(59,130,246,0.14); }
