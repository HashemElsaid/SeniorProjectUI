...
const ROLES: { role: UserRole; abbr: string; title: string; desc: string }[] = [
  {
    ...
    abbr: "PL",
    title: "Drone Pilot",
    desc: "Operate inspection drones and conduct aircraft surface surveys",
  },
  {
    role: "Analyst",
    abbr: "AN",
    title: "Inspection Analyst",
    desc: "Review AI findings, analyse reports and export inspection data",
  },
  {
    role: "Fleet Manager",
    abbr: "FM",
    title: "Fleet Manager",
    desc: "Oversee the full fleet, all missions and staff activities",
  },
];
              ...
              return (
                ...
                >
                  ...
                  <div style={{ textAlign: "left", flex: 1 }}>
                    <div style={{ fontSize: 13, fontWeight: 700, color: active ? colors.textPrimary : colors.textSecondary }}>
                      {title}
                    </div>
                  ...
                  <div
                    style={{
                      ...
                      height: 16,
                      borderRadius: "50%",
                      border: active ? "2px solid rgba(59,130,246,0.80)" : `2px solid ${colors.border}`,
                      background: active ? "rgba(59,130,246,0.80)" : "transparent",
                      flexShrink: 0,
                    }}
                  />
                </button>
