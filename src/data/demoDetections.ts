...
//
// ZONE COMPUTATION:
//   Zones were determined using image_surface_coordinates.csv (hit_x, hit_y, hit_z)
//   cross-referenced against the bounding boxes in regions.json.
//   The CSV covers the simulated fuselage camera path (img_00000–img_00492.png).
//   All 493 hit points fall within the Fuselage bounding box:
//     x ∈ [-3.10, 3.10]  y ∈ [-32.28, 34.04]  z ∈ [2.57, 8.90]
//   The real inspection photos (IMG_2023xxx) are from the same fuselage survey.
//   Zone = "Fuselage" for all entries — the only zone confirmed by 3D data.
...
const EDA: LiveDetection[] = [
  {
    ...
    zone: "Fuselage",     timestamp: "09:14:22",
  ...
  },
  {
    ...
    zone: "Fuselage",         timestamp: "09:11:08",
  ...
  },
  {
    ...
    zone: "Fuselage",     timestamp: "09:15:03",
  ...
  },
  {
    ...
    zone: "Fuselage",      timestamp: "09:13:28",
  ...
  },
  {
    ...
    zone: "Fuselage",  timestamp: "09:09:45",
...
const ECB: LiveDetection[] = [
  {
    ...
    zone: "Fuselage",      timestamp: "09:13:49",
  ...
  },
  {
    ...
    zone: "Fuselage",     timestamp: "09:14:37",
  ...
  },
  {
    ...
    zone: "Fuselage",      timestamp: "09:13:55",
  ...
  },
  {
    ...
    zone: "Fuselage",      timestamp: "09:14:05",
...
const EWA: LiveDetection[] = [
  {
    ...
    zone: "Fuselage",         timestamp: "09:11:22",
  ...
  },
  {
    ...
    zone: "Fuselage",         timestamp: "09:11:48",
  ...
  },
  {
    ...
    zone: "Fuselage",         timestamp: "09:10:42",
  ...
  },
  {
    ...
    zone: "Fuselage",         timestamp: "09:12:02",
...
const EEF: LiveDetection[] = [
  {
    ...
    zone: "Fuselage",      timestamp: "09:13:45",
  ...
  },
  {
    ...
    zone: "Fuselage",      timestamp: "09:13:12",
  ...
  },
  {
    ...
    zone: "Fuselage",     timestamp: "09:12:18",
  ...
  },
  {
    ...
    zone: "Fuselage",     timestamp: "09:15:22",
...
const EBA: LiveDetection[] = [
  {
    ...
    zone: "Fuselage",        timestamp: "09:16:22",
  ...
  },
  {
    ...
    zone: "Fuselage",         timestamp: "09:10:55",
  ...
  },
  {
    ...
    zone: "Fuselage",     timestamp: "09:12:48",
  ...
  },
  {
    ...
    zone: "Fuselage",         timestamp: "09:10:50",
  ...
  },
  {
    ...
    zone: "Fuselage",         timestamp: "09:12:08",
